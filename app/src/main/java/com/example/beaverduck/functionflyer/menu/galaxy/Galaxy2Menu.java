...
public class Galaxy2Menu extends Menu {
    public static final int BUTTON_SIZE = 250, LEVEL_BUTTON_SPACING = 40, Y_OFFSET = 200;
    private MenuState menuState;
    public Galaxy2Menu(MenuState menuState) {
        super(new ImageLabel(33, 33, 0), false, false);
        //TODO
    ...
    protected ArrayList<Label> getOptions() {
        ...
        labels.add(new ImageLabel(1, 0, GamePanel.getWIDTH()-BUTTON_SIZE, (GamePanel.getHEIGHT() - BUTTON_SIZE)/2));
    ...
    protected void onExit(int optionSelected) {
        switch (optionSelected){
            ...
            case 2:
                ...
                menuState.getLevelState().setLevel(4);
                break;
            case 3:
                menuState.getGsm().setGameState(1);
                menuState.getLevelState().setLevel(5);
                break;
            case 4:
                menuState.getGsm().setGameState(1);
                menuState.getLevelState().setLevel(6);
                break;
            case 5:
                menuState.getGsm().setGameState(1);
                menuState.getLevelState().setLevel(7);
                break;
            case 6:
                menuState.setMenu(0);
        }//end switch
